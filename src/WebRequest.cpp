...
bool AsyncWebServerRequest::_parseReqHead(){
  ...
  if(m == "GET"){
    _method = WEBSERVER_H::HTTP_GET;
  } else if(m == "POST"){
    _method = WEBSERVER_H::HTTP_POST;
  } else if(m == "DELETE"){
    _method = WEBSERVER_H::HTTP_DELETE;
  } else if(m == "PUT"){
    _method = WEBSERVER_H::HTTP_PUT;
  } else if(m == "PATCH"){
    _method = WEBSERVER_H::HTTP_PATCH;
  } else if(m == "HEAD"){
    _method = WEBSERVER_H::HTTP_HEAD;
  } else if(m == "OPTIONS"){
    _method = WEBSERVER_H::HTTP_OPTIONS;
  }
...
const char * AsyncWebServerRequest::methodToString() const {
  if(_method == WEBSERVER_H::HTTP_ANY) return "ANY";
  else if(_method & WEBSERVER_H::HTTP_GET) return "GET";
  else if(_method & WEBSERVER_H::HTTP_POST) return "POST";
  else if(_method & WEBSERVER_H::HTTP_DELETE) return "DELETE";
  else if(_method & WEBSERVER_H::HTTP_PUT) return "PUT";
  else if(_method & WEBSERVER_H::HTTP_PATCH) return "PATCH";
  else if(_method & WEBSERVER_H::HTTP_HEAD) return "HEAD";
  else if(_method & WEBSERVER_H::HTTP_OPTIONS) return "OPTIONS";
  return "UNKNOWN";
}
